    ...
    return (
        <>
          ...
          <Row>
              ...
              <Col span={12}><Statistic title="Total 24h Trading Volume" value={millify(globalStats.total24hVolume)} /></Col>
          ...
          <div className='home-heading-container'>
              <Title level={2} className='home-title'> Latest Cypto News.</Title>
